...
from .admin_product_edit_views import ProductCreateBasicView as BaseProductCreateBasicView, ProductEditView as BaseProductEditView, ProductUpdateBasicView as BaseProductUpdateBasicView, ProductToggleActiveView as BaseProductToggleActiveView, ProductAttributesListApiView as BaseProductAttributesListApiView, ProductAttributeCreateApiView as BaseProductAttributeCreateApiView, ProductAttributesReorderApiView as BaseProductAttributesReorderApiView, ProductAttributeUpdateApiView as BaseProductAttributeUpdateApiView, ProductAttributeDeleteApiView as BaseProductAttributeDeleteApiView, ProductAttributeValueCreateApiView as BaseProductAttributeValueCreateApiView, ProductAttributeValuesReorderApiView as BaseProductAttributeValuesReorderApiView, ProductAttributeValueUpdateApiView as BaseProductAttributeValueUpdateApiView, ProductAttributeValueDeleteApiView as BaseProductAttributeValueDeleteApiView, ProductHighlightsListApiView as BaseProductHighlightsListApiView, ProductHighlightCreateApiView as BaseProductHighlightCreateApiView, ProductHighlightUpdateApiView as BaseProductHighlightUpdateApiView, ProductHighlightDeleteApiView as BaseProductHighlightDeleteApiView, ProductHighlightsReorderApiView as BaseProductHighlightsReorderApiView, ProductVariantsListApiView as BaseProductVariantsListApiView, VariantCreateApiView as BaseVariantCreateApiView, VariantUpdateApiView as BaseVariantUpdateApiView, VariantDeleteApiView as BaseVariantDeleteApiView, VariantUploadImageView as BaseVariantUploadImageView, VariantImageDeleteView as BaseVariantImageDeleteView, VariantImageSetPrimaryView as BaseVariantImageSetPrimaryView, VariantImageReorderView as BaseVariantImageReorderView, VariantImageUpdateMetaView as BaseVariantImageUpdateMetaView, ProductImageUploadView as BaseProductImageUploadView, ProductImageDeleteView as BaseProductImageDeleteView, ProductImageSetPrimaryView as BaseProductImageSetPrimaryView, ProductImageReorderView as BaseProductImageReorderView, ProductImageUpdateAltTextView as BaseProductImageUpdateAltTextView, ProductComboComponentsListApiView as BaseProductComboComponentsListApiView, ProductComboCandidateProductsApiView as BaseProductComboCandidateProductsApiView, ProductComboComponentAddApiView as BaseProductComboComponentAddApiView, ProductComboComponentUpdateApiView as BaseProductComboComponentUpdateApiView, ProductComboComponentDeleteApiView as BaseProductComboComponentDeleteApiView
...
class ProductHighlightsListApiView(StaffRequiredMixin, BaseProductHighlightsListApiView):
    pass

class ProductHighlightCreateApiView(StaffRequiredMixin, BaseProductHighlightCreateApiView):
    pass

class ProductHighlightUpdateApiView(StaffRequiredMixin, BaseProductHighlightUpdateApiView):
    pass

class ProductHighlightDeleteApiView(StaffRequiredMixin, BaseProductHighlightDeleteApiView):
    pass

class ProductHighlightsReorderApiView(StaffRequiredMixin, BaseProductHighlightsReorderApiView):
    pass
...
class VariantImageUpdateMetaView(StaffRequiredMixin, BaseVariantImageUpdateMetaView):
    pass
...
class ProductImageUpdateAltTextView(StaffRequiredMixin, BaseProductImageUpdateAltTextView):
    pass
