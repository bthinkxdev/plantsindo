...
urlpatterns = [
    ...
    path('products/<int:pk>/highlights/', admin_views.ProductHighlightsListApiView.as_view(), name='product_highlights_list'),
    path('products/<int:pk>/highlights/add/', admin_views.ProductHighlightCreateApiView.as_view(), name='product_highlight_add'),
    path('products/<int:pk>/highlights/reorder/', admin_views.ProductHighlightsReorderApiView.as_view(), name='product_highlights_reorder'),
    path('highlights/<int:highlight_id>/update/', admin_views.ProductHighlightUpdateApiView.as_view(), name='product_highlight_update'),
    path('highlights/<int:highlight_id>/delete/', admin_views.ProductHighlightDeleteApiView.as_view(), name='product_highlight_delete'),
    ...
    path('variant-images/<int:image_id>/meta/', admin_views.VariantImageUpdateMetaView.as_view(), name='variant_image_meta'),
    ...
    path('products/base-images/<int:image_id>/alt-text/', admin_views.ProductImageUpdateAltTextView.as_view(), name='product_image_alt_text'),
